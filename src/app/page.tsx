  ...
  return (
    <main>
      <div className="flex max-w-[1440px] w-full mx-auto">
        <div className="hidden lg:block m-1.5 bg-white rounded w-full h-full max-w-[280px]">
        ...
        <div className="m-1.5 bg-white rounded w-full">
          ...
          <div className="px-2.5 py-3 items-center flex justify-between border-b border-[#e0e0e0]">
            <div className="block lg:hidden">
              <button className="flex items-center py-1.5 px-3 gap-2 border border-gray-400 rounded-lg focus:outline-none focus:ring-0">
